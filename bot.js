...
var rt = new Twit({
	consumer_key:         'rMnkhDkZpD3I1excl8G8kR7Jj',   						//replace the consumer key from you twitter account
  	consumer_secret:      'FIZDGySRVW6saY40iHMfnGt1vCoIwcCwgXrxxxGteUYZWC8SeE', //replace the consumer secret from you twitter account
  	access_token:         '1201085674096431105-7bUK5F5G0o91eUcvS78gMc74vQ6Ga7',	//replace the access token from you twitter account
  	access_token_secret:  'kH52eOPCQa5qaGhx3E36PsLxsi54Xrr17v8zllc5ZTrXG',		//replace the access token secret from you twitter account
}
);
